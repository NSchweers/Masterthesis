...
\fun{let}.  This makes global variables much more powerful than in more static
languages like C, as they are globally visible, but can be rebound for anything
